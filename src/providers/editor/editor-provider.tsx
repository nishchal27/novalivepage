...
/*
In Context with: nested container which is also an array.
until it finds a containerId it will keep looping and then when it does find, 
it'll place the element in that container
*/
//recursive function
const addAnElement = (
...
const editorReducer = (
  ...
  switch (action.type) {
    ...
    case "UPDATE_ELEMENT":
      ...
      //checking if the updated element is selected
    ...
    case "LOAD_DATA":
      return {
        ...
        editor: {
          ...
          //liveMode: adding flag to tell if data is directly from domain/production
