  ...
  return (
    <>
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col">
        ...
        <div
          className="flex bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text
      relative"
        >
          <div>
            ...
            {/* TODO: add google font here  */}
            <h1 className="text-3xl text-center md:text-[50px]">Nova</h1>
          </div>
          <div>
            <h1 className="text-9xl font-bold text-center md:text-[200px]">
              L
            </h1>
            <h1 className="text-3xl text-center md:text-[50px]">Live</h1>
          </div>
          <div>
            <h1 className="text-9xl font-bold text-center md:text-[200px]">
              P
            </h1>
            <h1 className="text-3xl text-center md:text-[45px]">Page</h1>
          </div>
        </div>
